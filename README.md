...
| Vue 新前端 | 92% | 登录、主框架、首页、配置、任务、日志、系统配置、功能中心、终端、审计、风险、备份、救援已原生化；移动端导航、窄屏表格、按钮折行、终端/SFTP/登录页响应式一期已补齐；AI 聊天输入区按钮布局已修正 |
...
| CI/测试 | 72% | GitHub Actions 已包含 Java 21、Node 20、前端构建、Maven 构建、脚本换行/语法和前后端接口映射检查 |
